...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-lg-6 pr-lg-0 col_left">
                <div class="row">
                    ...
                    <div class="col-12 col-lg-5 offset-1 makkelaar_logo">

                        <?php if ($content_left_footer = get_field('content_left_footer', 'options')) : ?>
                            <?php echo $content_left_footer; ?>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                ...
                <?php endif; ?>
                    <?php if ( have_rows( 'downloads', 'options' ) ) : ?>
                        ...
                        <div class="mb-2">
                            ...
                            <a href="<?php esc_url( $bestand ); ?>" target="_blank"><?php the_sub_field('documentnaam', 'options'); ?><i class="fa-solid fa-file-arrow-down ml-2"></i> </a>
