...
<footer>
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-lg-3 pr-lg-0 col_left">
                ...
                <?php if ($text_under_logo = get_field('text_under_logo', 'options')) : ?>
                    <?php echo $text_under_logo; ?>
                <?php endif; ?>


            </div>
            <div class="col-12 col-lg-2 makkelaar_logo">
                <?= !empty($img = get_field('makelaar_1', 'options')) ? wp_get_attachment_image($img['id'], 'full', false, ['class' => 'makelaar']) : '' ?>

            </div>
            <div class="col-sm-12 col-lg-2">
                <?php if ($titel = get_field('titel', 'options')) : ?>
                    <h4><?php echo esc_html($titel); ?></h4>
                <?php endif; ?>


                <?php if ($text_left = get_field('text_left', 'options')) : ?>
                    <?php echo $text_left; ?>
                <?php endif; ?>

            </div>
            <div class="col-12 col-lg-2 makkelaar_logo">
                <?= !empty($img = get_field('makelaar_2', 'options')) ? wp_get_attachment_image($img['id'], 'full', false, ['class' => 'makelaar']) : '' ?>
            ...
            <div class="col-sm-12 col-lg-3">
                <?php if ($titel = get_field('titel', 'options')) : ?>
                    <h4><?php echo esc_html($titel); ?></h4>
                <?php endif; ?>
                <?php if ($text_right = get_field('text_right', 'options')) : ?>
                    <?php echo $text_right; ?>
                <?php endif; ?>
            </div>
        </div>
...
<div class="overlay">
    ...
    <div class="row">
                ...
                <?php if (have_rows('downloads_overview', 'options')) : ?>
                    <?php while (have_rows('downloads_overview', 'options')) :
                        ...
                        <div class="js-accordion-item accordion__item">
                            <div class="accordionButton accordion-header js-accordion-header accordion__caption"><p
                                        class="mb-0 font-weight-bold"><?php the_sub_field('title', 'options'); ?></p>
                            </div>
                                    ...
                                    <?php while (have_rows('downloads', 'options')) :
                                        ...
                                        <div class="mb-2">
                                            <?php if ($bestand = get_sub_field('bestand', 'options')) : ?>
                                                <a href="<?= $bestand ?>"
                                                   target="_blank"><?php the_sub_field('documentnaam', 'options'); ?> -
                                                    ( Download <i class="fa-solid fa-file-arrow-down ml-2"></i> )</a>
        ...
        <div class="col-sm-12 col-lg-6 px-0 col_right">
            <?= !empty($img = get_field('overlay_img', 'options')) ? wp_get_attachment_image($img['id'], 'full', false, ['class' => 'overlay_img']) : '' ?>
        </div>
