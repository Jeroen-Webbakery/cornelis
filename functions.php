...
function theme_enqueue_styles()
{
    ...
    wp_enqueue_style('child-understrap-styles', get_stylesheet_directory_uri() . '/css/cornelis.min.css', array(), $the_theme->get('Version'));
    wp_enqueue_script('jquery');
    wp_enqueue_script('child-understrap-scripts', get_stylesheet_directory_uri() . '/js/cornelis.min.js', array(), $the_theme->get('Version'), true);
